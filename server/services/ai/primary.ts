...
// Function to generate a travel plan using primary AI model
export async function generateTravelPlan(
  ...
  try {
    ...
    // Sometimes the AI might add markdown formatting or extra text around the JSON
    ...
    console.error("Error generating travel plan with primary AI model:", error);
...
\n\n`;
    ...
    console.error("Error continuing conversation with primary AI model:", error);
