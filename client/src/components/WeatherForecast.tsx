      ...
      return (
        ...
        >
          ...
          <path
            ...
            strokeLinejoin="round"
            strokeWidth={2}
            d="M13 18.5v.5M9 18.5v.5M17 18.5v.5"
          />
        </svg>
      );
    } else if (
      ...
      return (
        ...
        >
          ...
          <path
            ...
            strokeLinejoin="round"
            strokeWidth={2}
            d="M12 16l-1 6m-2-6l2 6m2-6l1 6"
          />
        </svg>
      );
    } else if (
                      ...
                      <div className="flex-grow flex flex-wrap items-center">
                        ...
                        <div className="flex space-x-6">
                          <div>
                            ...
                            <div
                              className={`font-semibold ${getTemperatureColor(day.day.maxtemp_c)}`}
                            >
                          ...
                          <div>
                            ...
                            <div
                              className={`font-semibold ${getTemperatureColor(day.day.mintemp_c)}`}
                            >
              ...
              {weather.forecast.forecastday.map((day, index) => (
                ...
                >
                  ...
                  <AnimatePresence>
                    {selectedDay === index && (
                      <motion.div
                        className="mt-4 pt-4 border-t border-white-100"
